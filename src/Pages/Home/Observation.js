...
const Observation = () => {
  return (
    <div className="stats shadow w-11/12 p-20 bg-cyan-100">
      <div className="stat">
        ...
        <div className="stat-title font-bold">Website Views</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title font-bold">Total Likes</div>
